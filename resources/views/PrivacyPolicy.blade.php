...
<head>
    ...
    <meta property="og:title" content="Privacy Policy | Imageexpert24">
    <meta property="og:description" content="Read Imageexpert24's privacy policy to learn what information we collect from visitors and how we use it.">
...
<body class="font-body pt-[114px] text-body" data-bs-spy="scroll" data-bs-target="#toc-nav" data-bs-offset="140" tabindex="0">
    ...
    <div class="privacy-hero">
        <div class="mx-auto max-w-[1200px] px-4">
            ...
            <p>How Imageexpert24 collects, uses, and protects the information you share with us.</p>
        </div>
    </div>
